        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid #EAECF0', backgroundColor: '#fff' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '16px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              {subtitle && (
                <span style={{ backgroundColor: '#F4EBFF', color: '#7F56D9', fontSize: '12px', padding: '2px 10px', borderRadius: '16px', fontWeight: 600, border: '1px solid #F4EBFF' }}>
                  {subtitle}
                </span>
              )}
              {count !== undefined && (
                ...
                {columns.map((col, idx) => (
                  <th 
                    ...
                    style={{ 
                      ...
                      textTransform: col.textTransform || 'capitalize',
                      width: col.width
                    }}
                  >

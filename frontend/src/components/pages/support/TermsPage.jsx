            ...
            <main className="support-content">
                <div className="support-page-header">
                    ...
                    <p className="support-page-description">
                        Welcome to Eyenic. By accessing or using our platform, you agree to be bound by the following terms and conditions. Please read them carefully before placing an order or using any part of our service.
                    </p>
                </div>
                ...
                <div className="policy-section">
                    ...
                    <p className="policy-text">
                        These Terms &amp; Conditions ("Terms") govern your access to and use of the Eyenic website, mobile applications, and related services (collectively, the "Platform"). These Terms constitute a legally binding agreement between you ("User") and Eyenic ("we," "us," or "our"). By creating an account, placing an order, or otherwise engaging with the Platform, you confirm that you are at least 18 years of age and have the legal capacity to enter into these Terms.
                    </p>
                    <p className="policy-text">
                ...
                <div className="policy-section">
                    ...
                    <p className="policy-text">
                        All orders placed through the Platform are subject to acceptance by Eyenic. We reserve the right to refuse or cancel any order for reasons including, but not limited to, product unavailability, errors in pricing or product description, or suspected fraudulent activity. Payment must be made in full at the time of order placement unless a deferred prescription option is selected, in which case the full purchase price is collected upfront and the order is fulfilled upon receipt of the prescription.
                    </p>
                    <p className="policy-text">
                ...
                <div className="policy-section">
                    ...
                    <p className="policy-text">
                        Eyenic fabricates lenses based on the prescription information provided by the customer. It is the customer's sole responsibility to ensure the accuracy of the prescription submitted. We strongly recommend consulting a licensed ophthalmologist or optometrist before placing an order. Eyenic will not be held liable for adverse visual outcomes resulting from an incorrect prescription submitted by the customer.
                    </p>
                    <p className="policy-text">
                        Prescriptions submitted to Eyenic are processed and stored securely. By submitting a prescription, you grant Eyenic a limited licence to use that information solely for the purpose of fabricating your ordered lenses.
                    </p>
                </div>
                ...
                <div className="policy-section">
                    ...
                    <p className="policy-text">
                        All content on the Platform, including but not limited to text, images, graphics, logos, and software, is the intellectual property of Eyenic or its licensors. Unauthorised reproduction, distribution, or use of any content from the Platform is strictly prohibited and may result in legal action.
                    </p>
                </div>
                ...
                <div className="policy-section">
                    ...
                    <p className="policy-text">
                        To the maximum extent permitted by applicable law, Eyenic shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the Platform or any products purchased through it. Our total liability to you for any claim arising out of or relating to these Terms shall not exceed the amount you paid for the order in question.
                    </p>
                </div>
